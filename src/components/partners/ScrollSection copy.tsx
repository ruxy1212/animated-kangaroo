...
const ScrollSection: React.FC = () => {
  ...
  useGSAP(() => {
    ...
    const captureCanvasAsBackground = () => {
      if (canvasRef.current && secondSectionRef.current) {
        // Get the canvas data URL
        const imageUrl = canvasRef.current.toDataURL();
        
        // Apply the image to the second section background
        secondSectionRef.current.style.backgroundImage = `url(${imageUrl})`;
        secondSectionRef.current.style.backgroundSize = 'cover';
        secondSectionRef.current.style.backgroundPosition = 'center';
    ...
    ScrollTrigger.create({
      ...
      onEnter: () => {
        // Capture canvas as background
        captureCanvasAsBackground();
  ...
  return (
    <>
      ...
      <section 
        ...
        className="h-[100vh] bg-transparent relative"
      >
        {/* Background div that will receive the canvas image */}
        <div 
        ...
        <div className="flex flex-col justify-between gap-10 relative h-full z-10">
